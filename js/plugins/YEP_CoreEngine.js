...
//=============================================================================
/*:
 * @plugindesc v1.06 จำเป็นสำหรับปลั๊กอินส่วนใหญ่ของ Yanfly นอกจากนี้ยังมีการแก้ไขข้อผิดพลาดที่พบในโปรแกรม RPG Maker ด้วย
 ...
 *
 * @param Screen Width
 * @desc กำหนดความกว้างของหน้าจอเกม.
 * ค่าเริ่มต้น : 816
 * @default 816
 *
 * @param Screen Height
 * @desc กำหนดความสูงของหน้าจอเกม
 * ค่าเริ่มต้น : 624
 * @default 624
 *
 * @param Scale Battlebacks
 * @desc คุณต้องการกำหนดขนาดของพื้นหลังของฉากต่อสู้เท่ากับหน้าจอเกม
 * หรือไม่ ?
 * ไม่ - false     ใช่ - true
 * @default true
 *
 * @param Scale Title
 * @desc คุณต้องการกำหนดขนาดของฉากเริ่มเกมเท่ากับหน้าจอเกมหรือไม่ ?
 * ไม่ - false     ใช่ - true
 * @default true
 *
 * @param Scale Game Over
 * @desc คุณต้องการกำหนดขนาดของฉากเกมโอเวอร์เท่ากับหน้าจอเกมหรือไม่?
 * ไม่ - false     ใช่ - true
 * @default true
 *
 * @param Open Console
 * @desc สำหรับการทดสอบและแก้ไขข้อผิดพลาด โดยจะเปิด Console ขึ้นมา
 * ไม่เปิด - false     เปิด - true
 * @default false
 *
 * @param Reposition Battlers
 * @desc อนุญาตให้ปลั๊กอินแก้ไขตำแหน่งของ Battler ให้ตรงตามความละเอียด ?
 * ไม่ - false     ใช่ - true
 * @default true
 *
 * @param ---เงิน---
 ...
 *
 * @param Gold Max
 * @desc กำหนดจำนวนเงินสูงสุดที่ผู้เล่นสามารถมีได้
 * ค่าเริ่มต้น : 99999999
 * @default 99999999
 *
 * @param Gold Font Size
 * @desc กำหนดขนาดฟอนต์ที่ใช้ในการแสดงจำนวนเงิน
 * ค่าเริ่มต้น : 28
 * @default 20
 *
 * @param Gold Icon
 * @desc กำหนดไอคอนที่จะแสดงถึงจำนวนเงิน
 * window. ถ้าตั้งค่าไว้ที่ 0 จะไม่มีไอคอนแสดง
 * @default 313
 *
 * @param Gold Overlap
 * @desc กำหนดข้อความที่จะแสดงเมื่อตัวเลขจำนวนเงินเกินขนาดของหน้าต่างแสดง
 * จำนวนเงิน
 * @default จำนวนมาก
 *
 * @param ---ไอเทม---
 ...
 *
 * @param Default Max
 * @desc กำหนดจำนวนสูงสุดของไอเทมที่ผู้เล่นสามารถถือได้
 * ค่าเริ่มต้น : 99
 * @default 99
 *
 * @param Quantity Text Size
 * @desc กำหนดขนาดฟอนต์ที่ใช้แสดงจำนวนไอเทม
 * ค่าเริ่มต้น : 28
 * @default 20
 *
 * @param ---สถานะ---
 ...
 *
 * @param Max Level
 * @desc กำหนดระดับสูงสุดที่ตัวละครสามารถมีได้
 * ค่าเริ่มต้น : 99
 * @default 99
 *
 * @param Actor MaxHP
 * @desc กำหนด MaxHP สูงสุดที่ตัวละครสามารถมีได้
 * ค่าเริ่มต้น : 9999
 * @default 9999
 *
 * @param Actor MaxMP
 * @desc กำหนด MaxMP สูงสุดที่ตัวละครสามารถมีได้
 * ค่าเริ่มต้น : 9999
 * @default 9999
 *
 * @param Actor Parameter
 * @desc กำหนดค่าพารามิเตอร์สูงสุดของตัวละครที่สามารถมีได้
 * ค่าเริ่มต้น : 999
 * @default 999
 *
 * @param Enemy MaxHP
 * @desc กำหนด MaxHP สูงสุดที่มอนส์เตอร์สามารถมีได้
 * ค่าเริ่มต้น : 999999
 * @default 999999
 *
 * @param Enemy MaxMP
 * @desc กำหนด MaxMP สูงสุดที่มอนส์เตอร์สามารถมีได้
 * ค่าเริ่มต้น : 9999
 * @default 9999
 *
 * @param Enemy Parameter
 * @desc กำหนดค่าพารามิเตอร์สูงสุดของมอนส์เตอร์ที่สามารถมีได้
 * ค่าเริ่มต้น : 999
 * @default 999
 *
 * @param ---การต่อสู้---
 ...
 * @desc กำหนดความเร็วสำหรับแอนิเมชั่นในการต่อสู้ (ยิ่งน้อย ยิ่งเร็ว)
 * ค่าเริ่มต้น : 4
 * @default 4
 *
 * @param Flash Target
 * @desc เมื่อมอนส์เตอร์ถูกกำหนดเป้าหมาย จะมีการกระพริบ
 * ปิด - false     เปิด - true
 * @default false
 *
 * @param ---ฟอนต์---
 ...
 *
 * @param Chinese Font
 * @desc ฟอนต์เริ่มต้นสำหรับภาษาจีน
 * ค่าเริ่มต้น : SimHei, Heiti TC, sans-serif
 * @default SimHei, Heiti TC, sans-serif
 *
 * @param Korean Font
 * @desc ฟอนต์เริ่มต้นสำหรับภาษาเกหลี
 * ค่าเริ่มต้น : Dotum, AppleGothic, sans-serif
 * @default Dotum, AppleGothic, sans-serif
 *
 * @param Default Font
 * @desc ฟอนต์เริ่มต้นสำหรับเเกม
 * ค่าเริ่มต้น : GameFont
 * @default GameFont, Verdana, Arial, Courier New
 *
 * @param Font Size
 * @desc ขนาดฟอนต์เริ่มต้นที่จะถูกใช้
 * ค่าเริ่มต้น : 28
 * @default 28
 *
 * @param Text Align
 * @desc กำหนดตำแหน่งข้อความสำหรับหน้าต่างคำสั่ง
 ...
 * @desc จัดกลุ่มเข้าด้วยกันด้วยคอมม่า (,)
 * false - ปิด     true - เปิด
 * @default true
 *
 * @param Line Height
 * @desc กำหนดความสูงของเส้นทุกเส้นที่จะถูกใช้ในหน้าต่าง
 * ค่าเริ่มต้น : 36
 * @default 36
 *
 * @param Icon Width
 * @desc กำหนดความกว้างของไอคอนของคุณ
 * ค่าเริ่มต้น : 32
 * @default 32
 *
 * @param Icon Height
 * @desc กำหนดความสูงของไอคอนของคุณ
 * ค่าเริ่มต้น : 32
 * @default 32
 *
 * @param Face Width
 * @desc กำหนดความกว้างของหน้าตัวละคร
 * ค่าเริ่มต้น : 144
 * @default 144
 *
 * @param Face Height
 * @desc กำหนดความสูงของหน้าตัวละคร
 * ค่าเริ่มต้น : 144
 * @default 144
 *
 * @param Window Padding
 * @desc กำหนดระยะห่างของหน้าต่างทุกหน้างต่าง
 * ค่าเริ่มต้น : 18
 * @default 18
 *
 * @param Text Padding
 * @desc กำหนดระยะห่างของข้อความในหน้าต่างทุกหน้าต่าง
 * ค่าเริ่มต้น : 6
 * @default 6
 *
 * @param Window Opacity
 * @desc กำหนดความโปร่งใสของพื้นหลังสำหรับหน้าต่าง
 * ค่าเริ่มต้น : 192
 * @default 192
 *
 * @param Gauge Outline
 * @desc เปิดใช้งานกรอบสำหรับเกจ
 * false - ปิด     true - เปิด
 * @default true
 *
 * @param Gauge Height
 * @desc กำหนดความสูงของเกจ
 * ค่าเริ่มต้น : 6
 * @default 18
 *
 * @param Menu TP Bar
 * @desc สร้างแถบ TP ในหน้าต่างสถานะของตัวละคร
 * false - ปิด     true - เปิด
 * @default true
 *
 * @param ---สีของหน้าต่าง---
 ...
 *
 * @param Color: Normal
 * @desc เปลี่ยนสีข้อความสำหรับหน้าต่าง (ปกติ)
 * ค่าเริ่มต้น : 0
 * @default 0
 *
 * @param Color: System
 * @desc เปลี่ยนสีข้อความสำหรับหน้าต่าง (ระบบ)
 * ค่าเริ่มต้น : 16
 * @default 16
 *
 * @param Color: Crisis
 * @desc เปลี่ยนสีข้อความสำหรับหน้าต่าง (วิกฤต)
 * ค่าเริ่มต้น : 17
 * @default 17
 *
 * @param Color: Death
 * @desc เปลี่ยนสีข้อความสำหรับหน้าต่าง (ตาย)
 * ค่าเริ่มต้น : 18
 * @default 18
 *
 * @param Color: Gauge Back
 * @desc เปลี่ยนสีข้อความสำหรับหน้าต่าง (พื้นหลังเกจ)
 * ค่าเริ่มต้น : 19
 * @default 19
 *
 * @param Color: HP Gauge 1
 * @desc เปลี่ยนสีข้อความสำหรับหน้าต่าง (เกจ HP 1)
 * ค่าเริ่มต้น : 20
 * @default 20
 *
 * @param Color: HP Gauge 2
 * @desc เปลี่ยนสีข้อความสำหรับหน้าต่าง (เกจ HP 2)
 * ค่าเริ่มต้น : 21
 * @default 21
 *
 * @param Color: MP Gauge 1
 * @desc เปลี่ยนสีข้อความสำหรับหน้าต่าง (เกจ MP 1)
 * ค่าเริ่มต้น : 22
 * @default 22
 *
 * @param Color: MP Gauge 2
 * @desc เปลี่ยนสีข้อความสำหรับหน้าต่าง (เกจ MP 2)
 * ค่าเริ่มต้น : 23
 * @default 23
 *
 * @param Color: MP Cost
 * @desc เปลี่ยนสีข้อความสำหรับหน้าต่าง (MP ที่ต้องใช้)
 * ค่าเริ่มต้น : 23
 * @default 23
 *
 * @param Color: Power Up
 * @desc เปลี่ยนสีข้อความสำหรับหน้าต่าง (เพิมพลัง)
 * ค่าเริ่มต้น : 24
 * @default 24
 *
 * @param Color: Power Down
 * @desc เปลี่ยนสีข้อความสำหรับหน้าต่าง (ลดพลัง)
 * ค่าเริ่มต้น : 25
 * @default 25
 *
 * @param Color: TP Gauge 1
 * @desc เปลี่ยนสีข้อความสำหรับหน้าต่าง (เกจ TP 1)
 * ค่าเริ่มต้น : 28
 * @default 28
 *
 * @param Color: TP Gauge 2
 * @desc เปลี่ยนสีข้อความสำหรับหน้าต่าง (เกจ TP 2)
 * ค่าเริ่มต้น : 29
 * @default 29
 *
 * @param Color: TP Cost Color
 * @desc เปลี่ยนสีข้อความสำหรับหน้าต่าง (TP ที่ต้องใช้)
 * ค่าเริ่มต้น : 29
 * @default 29
 *
 * @help
 ...
 * ============================================================================
 *
 * Yanfly Engine Plugins - Core Engine สร้างขึ้นสำหรับ RPG Maker MV ปลั๊กอินนี้มีฟังก์ชันหลักในการแก้ไขข้อผิดพลาด
 * และอนุญาตให้ผู้ใช้สามารถความควบคุมฟีเจอร์ที่ต่าง ๆ ของ RPG Maker MV เช่น ขนาดหน้าจอเกม , ฟอนต์ , สีของหน้าต่าง และอื่น ๆ
 *
 * เพียงแค่วางเหนือปลั๊กอินอื่น ๆ ของ Yanfly Engine และ สามารถกำหนดค่าพารามิเตอร์ต่าง ๆ ได้ตามที่คุณต้องการ
 *
 * ============================================================================
 * ข้อผิดพลาดที่ถูกแก้ไขแล้ว
 * ============================================================================
 *
 * ปลั๊กอินนี้แก้ไขข้อผิดพลาดบางอย่างของ RPG Maker MV ดังต่อไปนี้
 *
 * แอนิเมชั่นทับซ้อน
 *   เมื่อสกิล/ไอเทมเล็งเป้าหมายไปยังมอนส์เตอร์หลายตัวพร้อมกันโดยใช้แอนิเมชั่นแบบเต็มหน้าจอ มันจะเกิดการทับซ้อน
 *   หลายครั้ง ทำให้รูปภาพดูผิดสัดส่วนจากผลของการทับซ้อน ปลั๊กอินนี้สามารแก้ไขปัญหาเหล่านั้นได้
 *   โดยการที่จะมีเพียงแอนิเมชั่นเดียวเท่านั้นที่จะถูกเล่นหลังจากการรวมกลุ่มของทุกแอนิเมชั่น
 *
 * การอัพเดทเหตุการณ์
 *   โดยปกติ การเคลื่อนที่ของเหตุการณ์จะมีความถี่อยู่ที่ 5 และหยุดในเวลาสั้น ๆ สำหรับเฟรมแทนที่จะเคลื่อนที่ต่อ
 *   ปลั๊กอินนี้จะแก้ไขปัญหาที่เกิดขึ้นโดยจะเหมือนกับเวอร์ชั่นก่อนหน้า ได้แก่ RPG Maker XP,
 * RPG Maker VX, and RPG Maker VX Ace ที่เหตุการณ์จะเคลื่อนที่โดยไม่หยุด
 *
 * ความเร็วการเคลื่อนที่ของเหตุการณ์
 *   ความเร็วการเคลื่อนที่ของเหตุการณ์จะช้าลงกว่าที่มันควรจะเป็น โดยข้อผิดพลาดเล็ก ๆ น้อย ๆ นี้เกิดขึ้นในรหัสตันฉบับ
 *   โดยปลั๊กอินนี้จะแก้ไขปัญหาที่เกิดขึ้นและแก้ไขให้เรียบร้อย
 *
 * ลำดับการเคลื่อนที่ของเหตุการณ์
 *   ถ้าเหตุการณ์เคลื่อนที่ผ่านคำสั่งของเหตุการณ์หรือการเปลี่ยนเงื่อนไขที่ตั้งค่าไปยังเหตุการณ์โดยผ่านหลาย ๆ หน้า
 *   จะทำให้เส้นทางการเคลื่อนที่ของเหตุการณ์หยุดชะงักในเส้นทางนั้น ๆ ปลั๊กอินนี้จะแก้ไข
 *   ปัญหาที่เกิดขึ้นและดำเนินการเคลื่อนที่ต่อจนสิ้นสุด
 *
 * การชนของเหตุการณ์
 *   เหตุการณ์ไม่สามารถเลคื่อนที่เหนือเหตุการณ์อื่นที่ได้ตั้งค่าเป็น "Below Characters" ซึ่งสร้างความยุ่งยาก
 *   สำหรับเหตุการณ์ ปลั๊กอินนี้จะแก้ไขปัญหาโดยทำให้การชนกันจะตรวจสอบเฉพาะเหตุการณ์ที่ตั้งค่าเป็น
 *  "Same as Characters" สำหรับเหตุการณ์ใด ๆ ที่อยู่เหนือหรือใต้ตัวละคร
 *   จะไม่เกิดการชนกันอีกต่อไป
 *
 * การแยกออกจากกันของหน้าจอ
 *   เมื่อเคลื่อนที่อย่างช้า ๆ  ไทล์บนหน้าจอจะเกิดการขาดออกจากกัน ซึ่งเป็นปัญหาที่พบเฉพาะบางระบบ
 *   โดยเฉพาะเครื่องคอมพิวเตอร์ที่มีสเปคค่อนข้างช้าจะพบปัญหานี้ได้มาก โดยปลั๊กอินนี้จะแก้ไขปัญหาที่เกิดขึ้นและ
 *   เชื่อมต่อไทล์ที่ถูกแยกออกจากกันอย่างถูกต้อง เมื่อเคลื่อนที่
 *
 * ความผิดเพี้ยนของสไปรต์
 *   เพราะพฤติกรรมที่แปลประหลาดในด้านคณิตศาสตร์ของ JavaScript บางครั้งค่า
 *   ที่มีจุดทศนิยมจะทำให้แผ่นสไปรต์ดูผิดเพี้ยนไป ปลั๊กอินนี้จะตัดทศนิยททิ้งและจะลบสไปรต์เฟรมที่ผิดพลาดออก
 *   โดยใช้เฉพาะจำนวนเต็มเท่านั้น
 *
 * ============================================================================
 * เงิน
 * ============================================================================
 *
 * คุณสามารถใช้ปลั๊กอินนี้ในการเพิ่ม/ลดจำนวนเงินที่มากกว่าข้อกำหนดของโปรแกรม ที่ 9,999,999 ได้
 *  เช่นเดียวกับการที่คุณสามารถวาง notetags ใน ไอเทม , อาวุธ และ เกราะ ที่มีราคาเกิน 999,999
 *
 * คำสั่งปลั๊กอิน:
 *   GainGold 1234567890       # ปาร์ตี้จะได้รับเงิน 1234567890
 *   LoseGold 9876543210       # ปาร์ตี้จะสูญเสียเงิน 9876543210
 *
 * Notetags ของไอเทม , อาวุธ , เกราะ
 *   <Price: x>
 *   เปลี่ยนราคาของไอเทมไปยัง x Notetag นี้จะอนุญาตให้คุณสามารถบายพาส
 *   ข้อกำหนดจำนวนเงินของโปรแกรมที่ 999,999 ได้
 *
 * Notetag ของมอนส์เตอร์
 *   <Gold: x>
 *   เปลี่ยนแปลงค่าเงินที่จะดรอปจากมอนส์เตอร์ไปยัง x Notetag นี้จะอนุญาตให้คุณ
 *   สามารถบายพาสข้อกำหนดจำนวนเงินของโปรแกรมที่ 9,999,999 ได้
 *
 * ============================================================================
 * ไอเทม
 * ============================================================================
 *
 * เปลี่ยนค่าพารามิเตอร์จะส่งผลกระทบต่อจำนวนสูงสุดของไอเทมที่ผู้เล่นสามารถครอบครองได้ในแต่ไอเทม
 * ถ้าคุณต้องการสร้างให้แต่ละไอเทมมีจำนวนสูงสุดที่สามารถครอบครองได้แตกต่างกันสามารถทำได้โดยใช้
 * Notetag ต่อไปนี้ :
 *
 * Notetag ไอเทม , อาวุธ , เกราะ :
 *   <Max Item: x>
 *   เปลี่ยนจำนวนสูงสุดที่สามารถครอบครองได้ไปยัง x.
 *
 * ============================================================================
 * สถานะ
 * ============================================================================
 *
 * ถึงแม้จะมีข้อจำกัดในการตั้งค่าพารามิเตอร์ที่ถูกจำกัดโดยขีดจำกัดปกติของ RPG Maker MV
 * เพื่อที่จะทำลายขีดจำกัดนั้น เราสามารถใช้ Notetag ต่อไปนี้ได้ ซึ่งอนุญาตให้สามารถ
 * ควบคุมเหนือค่าเหล่านั้นได้
 *
 * Notetag ตัวละคร
 *   <Initial Level: x>
 *   เปลี่ยนระดับเริ่มต้นของตัวละครไปยัง x นี่จะอนุญาตให้คุณสามารถงตั้งค่าได้มากกว่า
 *   ระดับที่ถูกจำกัดไว้ที่ 99
 *
 *   <Max Level: x>
 *   เปลี่ยนระดับสูงสุดของตัวละครไปยัง x นี่จะอนุญาตให้คุณสามารถงตั้งค่าได้มากกว่า
 *   ระดับที่ถูกจำกัดไว้ที่ 99
 *
 * Notetag เรียนรู้สกิลประจำคลาส
 *   <Learn at Level: x>
 *   เมื่อว่างในคลาส Notetag "เรียนรู้สกิลประจำคลาส" จะช่วยให้สามารถตั้งค่า
 *   การเรียนรู้สกิลเมื่อถึงระดับ x.
 *
 * Notetags อาวุธและเกราะ
 *   <stat: +x>
 *   <stat: -x>
 *   อนุญาตให้สามารถตั้งค่าอาวุธหรือเกราะเพิ่มหรือลดจำนวน x สถานะต่าง ๆ
 *   แทนที่ "stat" ด้วย "hp", "mp", "atk", "def", "mat", "mdf", "agi", หรือ
 *   "luk" เพื่อที่จะกำหนดสถานะเหล่านั้น นี่จะช่วยให้เหล่าเครื่องสวมใส่ของคุณสามารถทำลายขีดจำกัดที่ระบบจำกัดไว้ได้
 *
 * Notetags มอนส์เตอร์
 *   <stat: x>
 *   นี่จะเปลี่ยนสถานะของมอนส์เตอร์เป็นจำนวน x แทนที่ "stat" ด้วย "hp",
 *   "mp", "atk", "def", "mat", "mdf", "agi", หรือ "luk" เพื่อที่จะ
 *   กำหนดสถานะ นี่จะช่วยให้เหล่าเครื่องสวมใส่ของคุณสามารถทำลายขีดจำกัดที่ระบบจำกัดไว้ได้
 *
 *   <exp: x>
 *   นี่จะเปลี่ยนค่าประสบการณ์ที่มอนส์เตอร์จะให้ไปยัง x โดยจะอนุญาตให้มอนส์เตอร์ให้ค่าประสบการณ์
 *   ได้มากกว่า 9,999,999
 *
 * ============================================================================
 ...
 *
 * เวอร์ชั่น 1.06:
 * - ลบการแก้ไขข้อผิดพลาดเกี่ยวกับความถี่ของเหตุการณ์ เนื่องจากปัจจุบันได้รวมอยู่ในต้นฉบับอยู่แล้ว
 *
 * เวอร์ชั่น 1.05:
 * - เพิ่มพารามิเตอร์ 'Scale Game Over' ไปยังการตั้งค่าของปลั๊กอิน
 *
 * เวอร์ชั่น 1.04:
 * - เปลี่ยนแปลงการคำนวณทางคณิตศาสตร์สำหรับการกำหนดตำแหน่งขนาดของพื้นหลังของฉากต่อสู้เท่ากับหน้าจอเกม
 * - แก้ไขข้อผิดพลาดที่ ถ้าปาร์ตี้ล้มเหลวในการหนีจากการต่อสู้หรือสถานะจะถูกลบโดยการต่อสู้
 * *แก้ไขโดย Emjenoeg*
 *
 * เวอร์ชั่น 1.03:
 * - แก้ไขข้อผิดพลาดแปล ๆ ที่ทำให้ตำแหน่งของพื้นหลังฉากต่อสู้ถูกเลื่อนออกไปหลังจากการต่อสู้ 1 ครั้ง
 *
 * เวอร์ชั่น 1.02:
 * - แก้ไขข้อผิดพลาดสำหรับการเฟดหน้าจอบนโทรศัพท์มือถือที่ไม่ถูกต้อง
 * - เพิ่มพารามิเตอร์ 'Scale Battlebacks' และ 'Scale Title'
 *
 * เวอร์ชั่น 1.01:
 * - แก้ไขข้อผิดพลาดที่ ถ้าสไปรต์ของปุ่มมีมุมที่แตกต่างกัน จะส่งผลให้ไม่สามารถคลิกได้
 * *แก้ไขโดย Zalerinian*
 *
 * เวอร์ชั่น 1.00:
 * - ปลั๊กอินเสร็จสมบูรณ์!
 *
 * ============================================================================
 * บันทึกการเปลี่ยนแปลงสำหรับการแปลภาษา
 * ============================================================================
 * เวอร์ชั่น 1.00:
 * - การแปลเสร็จสมบูรณ์ในส่วนต่อไปนี้ : คำอธิบายปลั๊กอิน , ข้อความช่วยเหลือสำหรับปลั๊กอิน
 * -แก้ไขคำอธิบายที่ผิดพลาดในต้นฉบับภาษาอังกฤษบางส่วน
 * เวอร์ชั่น 1.01:
 * - แก้ไขคำผิดบางส่วนและปรับปรุงให้อ่านง่ายขึ้น
 * - แปลพารามิเตอร์ของปลั๊กอินเวอร์ชั่น 1.05
 * เวอร์ชั่น 1.02:
 * - แปลบันทึกการเปลี่ยนแปลง สำหรับปลั๊กอินเวอร์ชั่น 1.06
 */
//=============================================================================
